                ...
                {[
                  {
                    ...
                    features: ['Regular clothes', '48-hour turnaround', 'Standard folding', 'Free delivery over ₹300'],
                  },
                  {
                    title: 'Premium',
                    price: '₹249',
                ...
                {[
                  {
                    ...
                    price: '₹5,199',
                    unit: '/month',
                    description: '20 kgs of laundry per month.',
                    features: ['Up to 20 kgs monthly', 'Scheduled pickups', 'Standard folding', 'Free delivery'],
                  },
                  {
                    title: 'Monthly Plus',
                    price: '₹8,999',
                    unit: '/month',
                    description: '40 kgs of laundry per month.',
                    features: ['Up to 40 kgs monthly', 'Scheduled pickups', 'Premium folding', 'Free pickup & delivery', 'Priority service'],
                    popular: true,
                  },
                  {
                    title: 'Family Plan',
                    price: '₹13,499',
                    unit: '/month',
                    description: '70 kgs of laundry per month.',
                    features: ['Up to 70 kgs monthly', 'Weekly scheduled pickups', 'Premium folding', 'Free pickup & delivery', 'Priority service', 'Dedicated account manager'],
                  },
                ].map((plan, i) => (
                  <div 
                    key={i}
